<template>
	...
	>
		<path
			d="M9,0.5c-2.4,0-4.7,1-6.4,2.7C0.9,4.9,0,7.3,0,9.7c0,6.2,7.9,13.2,8.3,13.5c0.2,0.2,0.5,0.3,0.7,0.3
	...
	c0.4,0.2,0.8,0.5,1,0.8c0.2,0.4,0.4,0.8,0.4,1.3c0,0.6-0.2,1.2-0.7,1.6C10.2,11.8,9.6,12,9,12z"
			fill="#000000"
		/>
	</svg>
</template>
